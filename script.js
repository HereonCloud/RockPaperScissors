...
document.querySelectorAll("button").forEach((e) =>
  e.addEventListener("click", (b) => {
    ...
    document.getElementById(
      "opponent"
    ).style.backgroundImage = `url(assets/images/${opponent}.svg)`;
    document.getElementById(
      "player"
    ).style.backgroundImage = `url(assets/images/${player}.svg)`;
    document.getElementById("outcome").innerText = checkWinner(
      player,
      opponent
    );
  })
